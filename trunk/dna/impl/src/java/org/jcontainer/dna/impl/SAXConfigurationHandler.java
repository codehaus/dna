 ...
 * @version $Revision: 1.13 $ $Date: 2003-09-11 06:51:43 $
 */
   ...
   extends DefaultHandler
{
      ...
      throws SAXException
   {
      ...
      if ( m_elements.size() > 0 )
      {
         ...
         if ( ConfigurationUtil.ROOT_PATH.equals( parentPath ) )
         {
            path = parent.getName();
         }
         else
         {
            path = parentPath + ConfigurationUtil.PATH_SEPARATOR + parent.getName();
         }
      }
